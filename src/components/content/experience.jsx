...
/**
 * Component with the list of projects I worked on, using a template found online and applying some changes
 */
    ...
    <div className='experience'>
        ...
        <div className='timelineContainer'>
            <div className="timeline">
                <ul>
                    {/* 2021/09 - (Groovy web services) 2nd Team of the 3rd project */}
                    <li>
                    ...
                    {/* 2021/05 - (Workflows in Alfresco) 1st Team of the 3rd project */}
                    <li>
                        <div className="content">
                    ...
                    {/* 2020/11 - (RPA Developer) 2nd project as a RPA Developer */}
                    <li>
                        <div className="content">
                    ...
                    {/* 2020/01 - (Java Developer) 1st project */}
                    <li>
                        <div className="content">
